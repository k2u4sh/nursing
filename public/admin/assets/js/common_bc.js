    ...
    $.ajax({
        ...
        success:function(data){
            if(data.status == 'success')
            {
                ...
                // $('#dept_desc').val(data.data['dept_contents']);
...
function open_Form_detail(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            if(data.status == 'success')
            {
                var htm = '<div class="row"><div class="form-group"><b>Name:</b> '+data.data['first_name']+' '+data.data['last_name']+'</div></div>';
                htm += '<div class="row"><div class="form-group"><b>Email:</b> '+data.data['email']+'</div></div>';
                htm += '<div class="row"><div class="form-group"><b>Mobile:</b> '+data.data['mobile']+'</div></div>';
                htm += '<div class="row"><div class="form-group"><b>Message:</b></div></div>';
                htm += '<div class="row"><div class="form-group">'+data.data['message']+'</div></div>';
...
function open_EnquireForm_detail(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            if(data.status == 'success')
            {
                var htm = '<div class="row"><div class="form-group"><b>Name:</b> &emsp;'+data.data['first_name']+' '+data.data['last_name']+'</div></div>';
                htm += '<div class="row"><div class="form-group"><b>Email:</b> &emsp;'+data.data['email']+'</div></div>';
                htm += '<div class="row"><div class="form-group"><b>Mobile:</b> &emsp;'+data.data['mobile']+'</div></div>';
                htm += '<div class="row"><div class="form-group"><b>State:</b> &emsp;'+data.state+'</div></div>';
                htm += '<div class="row"><div class="form-group"><b>City:</b> &emsp;'+data.city+'</div></div>';
                htm += '<div class="row"><div class="form-group"><b>Course:</b> &emsp;'+data.course+'</div></div>';
                htm += '<div class="row"><div class="form-group"><b>Specialization:</b> &emsp;'+data.specialization+'</div></div>';
