    ...
    <section class="sub-page-banner cover no-repeat" style="background-image: url('/img/gallery-banner.jpg');">
        <div class="container d-flex align-items-center">
            <div>
                <div class="row">
                    <div class="col-lg-7">
                        <h1 class="bt">{{$department['dept_name']}}
                        </h1>
                        <div class="breadcrumb-wrap">
                            <span class="gt"><span><a href="{{ url('/') }}">Home</a></span> <span>></span> <a href="{{ url('department-list') }}">Department</a> <span class="">></span> </span> <span
                                class="rt">{{$department['dept_name']}}</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row">
                            ...
                            <div class="mb--3">
                                <ul class="nav nav-pills mb-0" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <a href="javascript:void(0);" class="nav-link {{($dept->id==last(request()->segments()))?'active':''}}" id="tab-{{$dept->id}}"
                        ...
                        <div class="col-md-9 detail-cnt-block pl-5--lg tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade {{($dep->id == last(request()->segments()))?'active show':''}}" id="tab_{{$dep->id}}" role="tabpanel" aria-labelledby="tab-{{$dep->id}}">
                                <div>
                                    <img src="/upload/department/{{$dep->dept_image}}" alt="" class="gap-bottom-sm" height="350px" style="width:100%">
                                </div>
