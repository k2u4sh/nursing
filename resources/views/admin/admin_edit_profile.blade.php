                                ...
                                <form method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <input type="text" name="user_name" id="user_name" class="form-control" placeholder="User Name" value="{{$data->registration_num?$data->registration_num:''}}" disabled>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label>Phone Number</label>
                                            <input type="text" onkeyup="validateMobile()" name="mobile" id="mobile" class="form-control" placeholder="Enter Phone Number" value="{{$data->mobile?$data->mobile:''}}">
                                        ...
                                        <div class="col-md-12 text-end mt-4">
                                            <button type="submit" class="btn btn-primary lg" id="update_profile">Update Profile</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
