...
.phonBar .input-icon-block {top: 35%;height: 35px;}
        ...
        <div class="cover no-repeat text-white tbf-cnt-block" style="background-image: url('../img/form-cnt-bg.jpg');">
            ...
            <div class="tbf-steps">
                <ul>
                    ...
                    <li>
                        <div>Once your application is registered you have to pay the <br> admission fees of Rs 500 by scanning the code</div>
                    </li>
                </ul>
            </div>
                ...
                <div class="register-form-block">
                    <form method="post">
                        ...
                        <div class="row">
                            <div class="contact-form-block col-md-6">
                                <div class="position-relative">
                                    <input type="text" placeholder="Enter First Name" autocomplete="off" name="first_name" id="first_name">
                                    <span id="first_name_error" style="color: red;"></span>
                                </div>
                            </div>
                            <div class="contact-form-block col-md-6">
                                <div class="position-relative">
                                    <input type="text" placeholder="Enter Last Name" autocomplete="off" name="last_name" id="last_name">
                                    <span id="last_name_error" style="color: red;"></span>
                                </div>
                            </div>
                            <div class="contact-form-block col-md-6">
                                <div class="position-relative">
                                    <input type="text" placeholder="Enter Email Id" autocomplete="off" name="email" id="email">
                                    <span id="email_error" style="color: red;"></span>
                                </div>
                            </div>
                            <div class="phonBar contact-form-block col-md-6">
                                <div class="position-relative mobile-number-block">
                                    <input type="text" placeholder="Mobile No." autocomplete="off" name="mobile" id="mobile" onkeyup="validateMobile()">
                            ...
                            <div class="contact-form-block col-md-6">
                                <div class="position-relative">
                                    <select class="select" name="qualification" autocomplete="off" id="qualification">
                                        <option value="">Select Qualification</option>
                                        <option value="12th">12th</option>
                                        <option value="10th">10th</option>
                                        <option value="Diploma or Cirtificate">Diploma or Certificate</option>
                            ...
                            <div class="contact-form-block col-md-6">
                                <div class="position-relative">
                                    <select class="select" name="course" autocomplete="off" id="course">
                            ...
                            <div class="contact-form-block col-md-6">
                                <div class="position-relative">
                                    <select class="select" name="stateId" autocomplete="off" id="stateId">
                            ...
                            <div class="contact-form-block col-md-6">
                                <div class="position-relative">
                                    <select class="select" name="cityId" autocomplete="off" id="cityId">
                        ...
                        <div class="form-checkbox mt-2 mb-2">
                            ...
                            <label for="admission_register_checkbox">Please agree the  <a target="_blank" href="{{route('terms_condition')}}" class="bt">Terms of
                                    Service</a> and <a target="_blank" href="{{route('privacy_policy')}}" class="bt">Privacy Policy</a></label>
                        </div>
                        <span class="aggrement" id="admission_register_checkbox_error" style="color: red;"></span>
                        <div class="bottomBtn login-buttons-block text-end">
                            <!-- <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#register_message" class="btn-v red sm rounded">Rigster</a> -->
                            <a href="javascript:void(0)" class="btn-v red sm rounded" id="register" style="text-decoration: none;">Register</a>
                        </div>
                    </form>
                </div>
                    ...
                    <form method="post">
                        ...
                        <div class="row">
                            <div class="contact-form-block col-md-12">
                                <div class="position-relative">
                                    <input type="text" placeholder="Enter Email Address" autocomplete="off" name="admission_email" id="admission_email">
                                    <span id="email_login_error" style="color: red;"></span>
                                </div>
                            </div>
                            <div class="contact-form-block col-md-12">
                                <div class="position-relative">
                                    <input type="password" placeholder="Enter Password" autocomplete="off" name="password" id="password">
                        ...
                        <div class="form-checkbox mt-4 mb-2">
                            <input type="checkbox" id="admission_login_checkbox">
                            <label for="admission_login_checkbox">I agree to JSW <a target="_blank" href="{{route('terms_condition')}}" class="bt">Terms of
                                    Service</a> and <a target="_blank" href="{{route('privacy_policy')}}" class="bt">Privacy Policy</a></label>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-body text-center">
                    <p class="fw-semibold">Thank you for submitting the application, your login credentials will be sent to your email id</p>
